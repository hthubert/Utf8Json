...
dotnet restore ..\src\Utf8Json\Spreads.Utf8Json.csproj
dotnet pack ..\src\Utf8Json\Spreads.Utf8Json.csproj -c RELEASE -o C:\transient\LocalNuget --version-suffix "%build%"R
